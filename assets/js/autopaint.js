...
var positionX = 1010; //起点X坐标
var positionY = 189; //起点Y坐标
//图案，颜色请参考颜色表，'-'代表不做处理。
var pattern = '-------------------------------------------00000000000000--\n' +
              '------------------------------0000000000000HHHHHHHHHHHHHH0-\n' +
              '------------------BB-------0000323233333330F1FFFFFFFFF14FH0\n' +
              '-----------------BBBB-------0FFF2F2F222233088888888FFF40F80\n' +
              '---BBBBB-BBBBB-22BBBBB--BB--B00FFFF2F2F2222000000008888880-\n' +
              '----BB---BB--B2222BBBBB-BB--B-B000000000000--------000000--\n' +
              '22222B22222BB222222BB22-B2-22222BB-------------------------\n' +
              '-22-BB22-B2-22222222B22-B2-22-BB---------------------------\n' +
              '-22-BB22222-22222222B22--2B2222BBBB------------------------\n' +
              '-22---22-2--22222222B22-2--22------------------------------\n' +
              '-22---22--2--222222B--22---22222---------------------------\n';
              '--------------2222-----------------------------------------\n';
              '---------------22------------------------------------------';
...
var runtime = Date.parse(new Date()); //运行时间
...
function Tick() { //每一刻的操作
    ...
    if(Date.parse(new Date()) >= runtime+900000){ //判断是否需要重载
        Reload(); //重载脚本
    } else {
